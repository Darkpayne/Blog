    ...
    <div className='bg-slate-100'>
        <div className="mx-auto container flex justify-between items-center">
            <div className="my-3 hidden md:block">
                ...
                <label class="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-black peer-focus:dark:text-black">Search</label>
            </div>
                </form>
            </div>
            <div className="">
