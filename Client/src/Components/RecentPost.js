...
const One = () =>{
    return(
        ...
        <a href="#" className='-top-14 z-[1] absolute'>
            <img className="rounded-t-lg" src="https://images.unsplash.com/photo-1606406054219-619c4c2e2100?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fGtvcmVhbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" alt="" className='w-[200px] rounded shadow-xl' />
        </a>
        <div className="p-5 absolute  z-[1] bottom-0">
            <a href="#">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">New posts</h5>
            </a>
