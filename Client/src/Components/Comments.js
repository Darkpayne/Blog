                    ...
                    <div className="  bg-white px-8 pb-8 pt-3 rounded-xl  shadow-slate-300">
                        ...
                        <form onSubmit={handleSignupButton} className="my-10">
                            <div className="flex flex-col space-y-5">
                                ...
                                <p className="text-center">Registered already? <span className="text-indigo-600 font-medium inline-flex space-x-1 items-center"><span onClick={handleLogin}>Login now </span><span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    ...
                    <div className="  bg-white px-8 pb-8 pt-3 rounded-xl  shadow-slate-300">
                        ...
                        <form onSubmit={handleLoginButton} className="my-10">
                            <div className="flex flex-col space-y-5">
                                ...
                                <p className="text-center">Not registered yet? <span className="text-indigo-600 cursor-pointer font-medium inline-flex space-x-1 items-center"><span onClick={handleSignUp}>Register now </span><span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                  </svg></span></span></p>
                            </div>
                        </form>
